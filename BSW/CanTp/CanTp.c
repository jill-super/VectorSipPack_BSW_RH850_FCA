 ...
 *  \trace         CREQ-102804
 *********************************************************************************************************************/
CANTP_LOCAL_INLINE FUNC(Std_ReturnType, CANTP_CODE) CanTp_TxStartConnection(PduIdType TxSduSnv, PduIdType TxHdl, PduLengthType SduLength);
...
#else
CANTP_DUMMY_STATEMENT(pTpRxState);   /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
CANTP_DUMMY_STATEMENT(pPdu);         /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
#endif /* (CANTP_RX_OPTIMIZATION != CANTP_OPT_ZERO_SDU) */
} /* CanTp_CanIfRxIndicationFF() */
...
CANTP_LOCAL_INLINE FUNC(Std_ReturnType, CANTP_CODE) CanTp_TxStartConnection(PduIdType TxSduSnv, PduIdType TxHdl, PduLengthType SduLength)
{
  ...
  CANTP_DUMMY_STATEMENT(TxSduSnv);                                                                                     /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
...
#else
CANTP_DUMMY_STATEMENT(pTpRxState);    /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
CANTP_DUMMY_STATEMENT(NotifyCode);    /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
CANTP_DUMMY_STATEMENT(DetError);      /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
CANTP_DUMMY_STATEMENT(ResetRequest);  /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
#endif /* (CANTP_RX_OPTIMIZATION != CANTP_OPT_ZERO_SDU) */
} /* CanTp_RxInit() */
...
CANTP_LOCAL FUNC(void, CANTP_CODE) CanTp_TxInit(CanTp_TxStatePtrType pTpTxState, CanTp_NotificationType NotifyCode, uint8 DetError)
{
  ...
  CANTP_DUMMY_STATEMENT(lTxHdl);   /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
...
#else
  CANTP_DUMMY_STATEMENT(pTpTxState);  /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
  CANTP_DUMMY_STATEMENT(NotifyCode);  /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
  CANTP_DUMMY_STATEMENT(DetError);    /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
#endif /* (CANTP_TX_OPTIMIZATION != CANTP_OPT_ZERO_SDU) */
} /* CanTp_TxInit() */
...
CANTP_LOCAL FUNC(Std_ReturnType, CANTP_CODE) CanTp_RxCheckChannelMode(PduIdType RxHdl)
{
  ...
  CANTP_DUMMY_STATEMENT(RxHdl);   /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
...
{
  Std_ReturnType  lResult;
  CANTP_DUMMY_STATEMENT(TxHdl);   /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
...
FUNC(Std_ReturnType, CANTP_CODE) CanTp_Transmit(PduIdType CanTpTxSduId, P2CONST(PduInfoType, AUTOMATIC, CANTP_APPL_DATA) CanTpTxInfoPtr)
{
  ...
  CANTP_DUMMY_STATEMENT(CanTpTxSduId);   /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
...
#if (CANTP_DEV_ERROR_DETECT == STD_ON)                                                                                 /* COV_CANTP_DET_CHECK TX */
  else if (CanTpTxSduId >= CanTp_Cfg_GetNumTxSduIds())                                                                 /* PRQA S 3355, 3358 */ /* MD_CanTp_3355, MD_CanTp_3358 */
  {
    lErrorId = CANTP_E_INVALID_TX_ID;
  }
  else if (CanTpTxInfoPtr == NULL_PTR)                                                                                 /* PRQA S 3201 */ /* MD_CanTp_3201 */
  {
    lErrorId = CANTP_E_PARAM_POINTER;
  }
# if (CANTP_SUPPORT_LONG_FF != STD_ON)
...
# endif
  ...
  else
  {
    ...
    if (CanTpTxInfoPtr->SduLength > 0)                                                                                 /* PRQA S 0505 */ /* MD_CanTp_0505_DET */
    {
...
#endif
      {
        ...
        lReturnValue = CanTp_TxStartConnection(CanTpTxSduId, lTxSduHdl, CanTpTxInfoPtr->SduLength);
      }
  ...
  /* ----- Development Error Report ------------------------------------------------------------ */
#if (CANTP_DEV_ERROR_REPORT == STD_ON)
  if (lErrorId != CANTP_E_NO_ERROR)                                                                                    /* PRQA S 3355, 3358 */ /* MD_CanTp_3355, MD_CanTp_3358 */
  {
...
FUNC(Std_ReturnType, CANTP_CODE) CanTp_ChangeParameter(PduIdType id, TPParameterType parameter, uint16 value)
{
  ...
  CANTP_DUMMY_STATEMENT(id);   /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
...
FUNC(Std_ReturnType, CANTP_CODE) CanTp_CancelReceive(PduIdType CanTpRxSduId)
{
  ...
  CANTP_DUMMY_STATEMENT(CanTpRxSduId);   /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
