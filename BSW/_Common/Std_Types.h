...
/* vadnra */
#define DemConf_DemEventParameter_FLS_E_COMPARE_FAILED DEM_EVENT_STATUS_FAILED
#define DemConf_DemEventParameter_FLS_E_ERASE_FAILED DEM_EVENT_STATUS_FAILED
#define DemConf_DemEventParameter_FLS_E_READ_FAILED DEM_EVENT_STATUS_FAILED
#define DemConf_DemEventParameter_FLS_E_WRITE_FAILED DEM_EVENT_STATUS_FAILED
#define DemConf_DemEventParameter_FLS_E_READ_FAILED_DED DEM_EVENT_STATUS_FAILED
#define DemConf_DemEventParameter_FLS_E_ECC_FAILED DEM_EVENT_STATUS_FAILED
#define DemConf_DemEventParameter_FLS_E_HW_FAIL DEM_EVENT_STATUS_FAILED
/**********************************************************************************************************************
