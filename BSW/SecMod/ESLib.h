 ...
 * $LastChangedDate: 2018-02-13 10:18:43 +0100 (Di, 13 Feb 2018) $
 ...
 *                          KDF (key derivation function according to PKCS#5 and X9.63)
 ...
 *                          EC-D/H (key agreement X25519)
 *                          ChaCha20 encryption / decryption
 *                          Poly1305 authentication
 *                          AEAD as specified in RFC 7539 (ChaCha20 & Poly1305)
 *****************************************************************************/
...
CRYPTOCV_FUNC( eslt_ErrorCode ) esl_initKDFX963SHA256 ( CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceKDFX963SHA256 ) workSpace);
/* ErrorCode:
      ESL_ERC_NO_ERROR
      ESL_ERC_WS_TOO_SMALL
      ESL_ERC_WS_STATE_INVALID
...
CRYPTOCV_FUNC( eslt_ErrorCode ) esl_deriveKeyKDFX963SHA256( CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceKDFX963SHA256 ) workSpace,
   const eslt_Length secretLength,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) secret,
   const eslt_Length infoLength,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) info,
   const eslt_Length keyLength,
   CRYPTOCV_P2VAR_PARA( eslt_Byte ) key );
/* ErrorCode:
      ESL_ERC_NO_ERROR
      ESL_ERC_WS_TOO_SMALL
      ESL_ERC_WS_STATE_INVALID
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_initEncryptChaCha20 (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceChaCha20 ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) key,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) nonce,
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_initDecryptChaCha20 (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceChaCha20 ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) key,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) nonce,
   const eslt_Size32 blockCount);
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_encryptChaCha20 (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceChaCha20 ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) in,
   const eslt_Length inSize,
   CRYPTOCV_P2VAR_PARA( eslt_Byte ) out,
   CRYPTOCV_P2VAR_PARA( eslt_Length ) outSize);
/* ErrorCode:
      ESL_ERC_NO_ERROR
      ESL_ERC_PARAMETER_INVALID
      ESL_ERC_WS_STATE_INVALID
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_decryptChaCha20 (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceChaCha20 ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) in,
   const eslt_Length inSize,
   CRYPTOCV_P2VAR_PARA( eslt_Byte ) out,
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_initPoly1305 (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpacePoly1305 ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) key);
/* ErrorCode:
      ESL_ERC_PARAMETER_INVALID
      ESL_ERC_WS_TOO_SMALL
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_updatePoly1305 (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpacePoly1305 ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) message,
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_finalizePoly1305 (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpacePoly1305 ) workSpace,
   CRYPTOCV_P2VAR_PARA( eslt_Byte ) tag);
/* ErrorCode:
      ESL_ERC_PARAMETER_INVALID
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_verifyPoly1305 (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpacePoly1305 ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) tag);
/* ErrorCode:
      ESL_ERC_PARAMETER_INVALID
      ESL_ERC_WS_STATE_INVALID
      ESL_ERC_INCORRECT_TAG
      ESL_ERC_NO_ERROR */
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_initEncryptChaChaPoly (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceChaChaPoly ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) key,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) nonce);
/* ErrorCode:
      ESL_ERC_PARAMETER_INVALID
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_initDecryptChaChaPoly (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceChaChaPoly ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) key,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) nonce);
/* ErrorCode:
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_updateAADChaChaPoly (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceChaChaPoly ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) aad,
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_updateDataChaChaPoly (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceChaChaPoly ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) in,
   const eslt_Length inSize,
   CRYPTOCV_P2VAR_PARA( eslt_Byte ) out,
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_finalizeChaChaPoly (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceChaChaPoly ) workSpace,
   CRYPTOCV_P2VAR_PARA( eslt_Byte ) tag);
/* ErrorCode:
      ESL_ERC_PARAMETER_INVALID
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_verifyChaChaPoly (
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceChaChaPoly ) workSpace,
   CRYPTOCV_P2CONST_PARA( eslt_Byte ) tag);
/* ErrorCode:
      ESL_ERC_PARAMETER_INVALID
 ...
 *****************************************************************************/
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_initECBD (
        CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceECBD ) workSpace,
        const eslt_Size32 nDevices,
        const eslt_Size32 deviceID,
        CRYPTOCV_P2CONST_PARA( eslt_EccDomain ) domain,
        CRYPTOCV_P2CONST_PARA( eslt_EccDomainExt ) domainExt,
        CRYPTOCV_P2CONST_PARA( eslt_EccSpeedUpExt ) speedUpExt);
/*  error codes: */
/*  ESL_ERC_PARAMETER_INVALID */
/*  ESL_ERC_WS_TOO_SMALL */
/*  ESL_ERC_INPUT_INVALID */
/*  ESL_ERC_NO_ERROR */

extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_generateEphemeralKeyPairECBD (CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceECBD ) workSpace,
                                                                          CRYPTOCV_P2VAR_PARA( eslt_Byte ) privateKey,
                                                                          CRYPTOCV_P2VAR_PARA( eslt_Byte ) publicKey_x,
                                                                          CRYPTOCV_P2VAR_PARA( eslt_Byte ) publicKey_y);
/*  error codes: */
/*  ESL_ERC_PARAMETER_INVALID */
/*  ESL_ERC_WS_STATE_INVALID */
/*  ESL_ERC_WS_TOO_SMALL */
/*  ESL_ERC_RNG_FAILED */
/*  ESL_ERC_ECC_INTERNAL_ERROR */
/*  ESL_ERC_NO_ERROR */

extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_calculateIntermediateECBD (CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceECBD ) workSpace,
                               CRYPTOCV_P2CONST_PARA( eslt_Byte ) pubKeyLeft_x,
                               CRYPTOCV_P2CONST_PARA( eslt_Byte ) pubKeyLeft_y,
                               CRYPTOCV_P2CONST_PARA( eslt_Byte ) pubKeyRight_x,
                               CRYPTOCV_P2CONST_PARA( eslt_Byte ) pubKeyRight_y,
                               CRYPTOCV_P2VAR_PARA( eslt_Byte ) intermediate_x,
                               CRYPTOCV_P2VAR_PARA( eslt_Byte ) intermediate_y);
/*  error codes: */
/*  ESL_ERC_PARAMETER_INVALID */
/*  ESL_ERC_WS_STATE_INVALID */
/*  ESL_ERC_WS_TOO_SMALL */
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_initSharedSecretECBD (CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceECBD ) workSpace);
/*  error codes: */
/*  ESL_ERC_PARAMETER_INVALID */
/*  ESL_ERC_WS_STATE_INVALID */
/*  ESL_ERC_WS_TOO_SMALL */
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_updateSharedSecretECBD (CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceECBD ) workSpace,
                            const eslt_Size32          deviceID,
                            CRYPTOCV_P2CONST_PARA( eslt_Byte ) intermediate_x,
                            CRYPTOCV_P2CONST_PARA( eslt_Byte ) intermediate_y);
/*  error codes: */
/*  ESL_ERC_PARAMETER_INVALID */
/*  ESL_ERC_WS_STATE_INVALID */
/*  ESL_ERC_WS_TOO_SMALL */
...
extern CRYPTOCV_FUNC( eslt_ErrorCode ) esl_retrieveSharedSecretECBD (CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceECBD ) workSpace,
                              CRYPTOCV_P2VAR_PARA( eslt_Byte ) sharedSecret_x,
                              CRYPTOCV_P2VAR_PARA( eslt_Byte ) sharedSecret_y);
/*  error codes: */
/*  ESL_ERC_PARAMETER_INVALID */
/*  ESL_ERC_WS_STATE_INVALID */
/*  ESL_ERC_WS_TOO_SMALL */
