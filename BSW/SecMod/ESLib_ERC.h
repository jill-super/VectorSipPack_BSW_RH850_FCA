...
typedef enum _eslt_ErrorCode {
   ...
   ESL_ERC_BUFFER_TOO_SMALL                  = ESL_ERC_OUTPUT_SIZE_TOO_SHORT,   /*  alias */
   ...
   ESL_ERC_INCORRECT_MAC                     = ESL_ERC_HMAC_INCORRECT_MAC, /*  NOT specific for HMAC!! */
   ...
   ESL_ERC_INVALID_KEY_LENGTH                = ESL_ERC_GCM_INVALID_KEY_LENGTH,  /*  NOT specific for GCM!! */
   ...
   ESL_ERC_INCORRECT_TAG                     = ESL_ERC_INCORRECT_MAC,
