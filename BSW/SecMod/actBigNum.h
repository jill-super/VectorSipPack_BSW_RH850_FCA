...
/* Get the higher word of a DDigit */
...
#define actBNAssign(a,b,l)  actBNCopy ((a), (b), (l))
 ...
 **
 ** FUNCTION:
 ** int actBNRandomize (actBNDIGIT* output, int length)
 **
 **  The function to provide a random BigNum.
 **
 ** input:
 ** - bigNum:     pointer to BigNum buffer
 ** - digits:     digits of random to fetch
 **
 ** output:
 ** - bigNum:     random BigNum of length digits
 **
 ** assumes:
 **
 ** uses:
 ...
 **
 ***************************************************************************/
extern CRYPTOCV_FUNC( int ) actBNRandomize (CRYPTOCV_P2VAR_PARA( actBNDIGIT ) bigNum, int digits);
 ...
 **                    const actBNLENGTH length)
 **
 **   Reset BigNum (a) to ZERO (0).
 **
 ** input:                                              (length in digits)
 ** - a:       the number to be reset                        length
 ** - length:  length of a
 **
 ** output:
 ** - a:       a == 0                                        length
 ...
 **
 ***************************************************************************/
#define actBNSetZero(a,l)   actBNSet ((a), (l), ((actBNDIGIT) 0))

/****************************************************************************
 **
 ** FUNCTION:
 **  void actBNSetOne (actBNDIGIT* a,
 **              const actBNLENGTH length)
 **
 **   Sets BigNum (a) to ONE (1).
 **
 ** input:                              (length in digits)
 ** - a:       the number to be set           length
 ** - length:  length of a
 **
 ** output:
 ** - a:       a == 1                         length
 ...
 **
 ***************************************************************************/
#define actBNSetOne(a,l)    actBNSet ((a), (l), ((actBNDIGIT) 1))
 ...
 **
 ***************************************************************************/
int actBNAreEqual (CRYPTOCV_P2CONST_PARA( actBNDIGIT ) a,
