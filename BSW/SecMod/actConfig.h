 ...
 ***************************************************************************/
#ifndef actBN_MOD_EXP_WINDOW_SIZE
...
/*--------------------------------------------------------------------------
   ...
   -----------------------------------------------------------------------*/
#if !defined( actAES_SPEED_UP )
# define actAES_SPEED_UP   3
#endif
/*--------------------------------------------------------------------------
...
/*--------------------------------------------------------------------------
   ...
   -----------------------------------------------------------------------*/
#if !defined( actChaCha20_SPEED_UP )
# define actChaCha20_SPEED_UP   1
#endif
