...
#define ESL_PM_PKCS5                      0x01u       /*  PKCS#5 defined for blocks of 8 bytes only! */
#define ESL_PM_PKCS7                      0x03u       /*  PKCS#7 defined for blocks of 1...255 bytes */
...
typedef struct
{
   ...
   eslt_Size32 scratch;        /* some scratch pad memory */
...
# if (ACT_PLATFORM_ALIGNMENT == 1) || (ACT_PLATFORM_ALIGNMENT == 2) || (ACT_PLATFORM_ALIGNMENT == 4) || (ACT_PLATFORM_ALIGNMENT == 8)
...
#define ESL_MAXSIZEOF_WS_AES128           (ESL_MAXSIZEOF_WS_AES128BLOCK + ( 2u * ESL_SIZEOF_AES128_BLOCK ) + 16u)
/* For (init, transform(block), ... , transform(block)) sequences */
#define ESL_MINSIZEOF_WS_AES128           ESL_MAXSIZEOF_WS_AES128 

/* AES192 workSpace sizes */
/* For (initTransformBlock, transformBlock, transformBlock, ..) calls */
#define ESL_MAXSIZEOF_WS_AES192BLOCK      (260u)
/* For (init, transform(input, len), ... ,transform(input, len), finalize) sequences */
#define ESL_MAXSIZEOF_WS_AES192           (ESL_MAXSIZEOF_WS_AES192BLOCK + ( 2u * ESL_SIZEOF_AES192_BLOCK ) + 16u)
/* For (init, transform(block), ... , transform(block)) sequences */
#define ESL_MINSIZEOF_WS_AES192           ESL_MAXSIZEOF_WS_AES192

/* AES256 workSpace sizes */
/* For (initTransformBlock, transformBlock, transformBlock, ..) calls */
#define ESL_MAXSIZEOF_WS_AES256BLOCK      (260u)
/* For (init, transform(input, len), ... ,transform(input, len), finalize) sequences */
#define ESL_MAXSIZEOF_WS_AES256           (ESL_MAXSIZEOF_WS_AES256BLOCK + ( 2u * ESL_SIZEOF_AES256_BLOCK ) + 16u)
/* For (init, transform(block), ... , transform(block)) sequences */
#define ESL_MINSIZEOF_WS_AES256           ESL_MAXSIZEOF_WS_AES256 

/* DES workSpace sizes */
/* For (initTransformBlock, transformBlock, transformBlock, ..) calls */
#define ESL_MAXSIZEOF_WS_DESBLOCK         (200u)
/* For (init, transform(input, len), ... ,transform(input, len), finalize) sequences */
#define ESL_MAXSIZEOF_WS_DES              (ESL_MAXSIZEOF_WS_DESBLOCK + ( 2u * ESL_SIZEOF_DES_BLOCK ) + 16u)
/* For (init, transform(block), ... , transform(block)) sequences */
#define ESL_MINSIZEOF_WS_DES              ESL_MAXSIZEOF_WS_DES

/* TDES workSpace sizes */
/* For (initTransformBlock, transformBlock, transformBlock, ..) calls */
#define ESL_MAXSIZEOF_WS_TDESBLOCK         (500u)
/* For (init, transform(input, len), ... ,transform(input, len), finalize) sequences */
#define ESL_MAXSIZEOF_WS_TDES              (ESL_MAXSIZEOF_WS_TDESBLOCK + ( 2u * ESL_SIZEOF_DES_BLOCK ) + 16u)
/* For (init, transform(block), ... , transform(block)) sequences */
#define ESL_MINSIZEOF_WS_TDES              ESL_MAXSIZEOF_WS_TDES
...
/* For (init, transform(block), ... , transform(block)) sequences */
#define ESL_MINSIZEOF_WS_RC2              ESL_MAXSIZEOF_WS_RC2
...
/* For (init, update(input, len), ... ,update(input, len), finalize) sequences */
#define ESL_MAXSIZEOF_WS_SHA1             (ESL_SIZEOF_SHA1_BLOCK + ESL_SIZEOF_SHA1_DIGEST + ACT_ALIGN(12u))
/* For (init, update(block), ... , update(block)) sequences */
#define ESL_MINSIZEOF_WS_SHA1             ESL_MAXSIZEOF_WS_SHA1

/* SHA-256 workSpace sizes */
/* For (init, update(input, len), ... ,update(input, len), finalize) sequences */
#define ESL_MAXSIZEOF_WS_SHA256            (ESL_SIZEOF_SHA256_BLOCK + ESL_SIZEOF_SHA256_DIGEST + ACT_ALIGN(12u))
/* For (init, update(block), ... , update(block)) sequences */
#define ESL_MINSIZEOF_WS_SHA256            ESL_MAXSIZEOF_WS_SHA256
...
/* For (init, update(input, len), ... ,update(input, len), finalize) sequences */
#define ESL_MAXSIZEOF_WS_SHA512            (ESL_SIZEOF_SHA512_BLOCK + ESL_SIZEOF_SHA512_DIGEST + 24u)
/* For (init, update(block), ... , update(block)) sequences */
...
/* MD5 workSpace sizes */
/* For (init, update(input, len), ... ,update(input, len), finalize) sequences */
#define ESL_MAXSIZEOF_WS_MD5              (ESL_SIZEOF_MD5_BLOCK + ESL_SIZEOF_MD5_DIGEST + ACT_ALIGN(12u))
/* For (init, update(block), ... , update(block)) sequences */
#define ESL_MINSIZEOF_WS_MD5              ESL_MAXSIZEOF_WS_MD5

/* HMACSHA-1 workSpace sizes */
/* For (init, update(input, len), ... ,update(input, len), finalize) sequences */
#define ESL_MAXSIZEOF_WS_HMACSHA1         (ESL_MAXSIZEOF_WS_SHA1 + ESL_SIZEOF_SHA1_BLOCK + ACT_ALIGN(4u))

/* HMACSHA-256 workSpace sizes */
/* For (init, update(input, len), ... ,update(input, len), finalize) sequences */
#define ESL_MAXSIZEOF_WS_HMACSHA256       (ESL_MAXSIZEOF_WS_SHA256 + ESL_SIZEOF_SHA256_BLOCK + 8u)

/* RIPEMD-160 */
#define ESL_MAXSIZEOF_WS_RIPEMD160        ESL_MAXSIZEOF_WS_SHA1
#define ESL_MAXSIZEOF_WS_HMACRIPEMD160    ESL_MAXSIZEOF_WS_HMACSHA1
#define ESL_MINSIZEOF_WS_RIPEMD160        ESL_MAXSIZEOF_WS_SHA1
...
#define ESL_MAXSIZEOF_WS_KDF2HMACSHA1     (ESL_MAXSIZEOF_WS_HMACSHA1 + ( 2u * ESL_SIZEOF_SHA1_DIGEST ) + ACT_ALIGN(4u))

/* KDF-X963 workSpace sizes */
#define ESL_MAXSIZEOF_WS_KDFX963SHA1      (ESL_MAXSIZEOF_WS_SHA1 + ESL_SIZEOF_SHA1_DIGEST)
#define ESL_MAXSIZEOF_WS_KDFX963SHA256    (ESL_MAXSIZEOF_WS_SHA256 + ESL_SIZEOF_SHA256_DIGEST)

/* FIPS186 workspace sizes */
#define ESL_MAXSIZEOF_WS_FIPS186          ((ESL_MAXSIZEOF_WS_SHA1) + (ESL_SIZEOF_SHA1_DIGEST) + ACT_ALIGN(4u))
...
/* p_bits, n_bits <= 320 */
#define ESL_SIZEOF_WS_ECP_320_KG   (760u) /* kg, dh_prim  */
#define ESL_SIZEOF_WS_ECP_320_DH   (800u) /* dh           */
#define ESL_SIZEOF_WS_ECP_320_SP   (920u) /* sp           */
#define ESL_SIZEOF_WS_ECP_320_VP  (1128u) /* vp           */

/* p_bits, n_bits <= 384 */
#define ESL_SIZEOF_WS_ECP_384_KG   (888u) /* kg, dh_prim  */
#define ESL_SIZEOF_WS_ECP_384_DH   (936u) /* dh           */
#define ESL_SIZEOF_WS_ECP_384_SP  (1080u) /* sp           */
#define ESL_SIZEOF_WS_ECP_384_VP  (1328u) /* vp           */

/* p_bits, n_bits <= 512 */
#define ESL_SIZEOF_WS_ECP_512_KG  (1060u) /* kg, dh_prim  */
#define ESL_SIZEOF_WS_ECP_512_DH  (1208u) /* dh           */
#define ESL_SIZEOF_WS_ECP_512_SP  (1400u) /* sp           */
#define ESL_SIZEOF_WS_ECP_512_VP  (1728u) /* vp           */

/* p_bits, n_bits <= 521 (should be sufficient for 544 bits) */
#define ESL_SIZEOF_WS_ECP_521_KG  (1112u) /* kg, dh_prim  */
#define ESL_SIZEOF_WS_ECP_521_DH  (1276u) /* dh           */
#define ESL_SIZEOF_WS_ECP_521_SP  (1480u) /* sp           */
#define ESL_SIZEOF_WS_ECP_521_VP  (1828u) /* vp           */

/* =============================================================================
 * = EC-B/D key agreement workspace size
 * ============================================================================= */
#define ESL_SIZEOF_WS_ECBD_160     (540u)
#define ESL_SIZEOF_WS_ECBD_192     (600u)
#define ESL_SIZEOF_WS_ECBD_224     (680u)
#define ESL_SIZEOF_WS_ECBD_256     (760u)
#define ESL_SIZEOF_WS_ECBD_320     (900u)
#define ESL_SIZEOF_WS_ECBD_384    (1040u)
#define ESL_SIZEOF_WS_ECBD_512    (1340u)
#define ESL_SIZEOF_WS_ECBD_521    (1400u)
...
/* n_bits <= 512 */
#define ESL_SIZEOF_WS_RSA_PUB_512               ( 450u)
#define ESL_SIZEOF_WS_RSA_PRIV_512              ( 450u)
/* n_bits <= 1024 */
#define ESL_SIZEOF_WS_RSA_PUB_1024              ( 820u)
#define ESL_SIZEOF_WS_RSA_PRIV_1024             ( 820u)
#define ESL_SIZEOF_WS_RSA_PRIV_CRT_1024         ( 596u)   /* assumes: p_bits, q_bits <= 544  */
/* n_bits <= 1536 */
#define ESL_SIZEOF_WS_RSA_PUB_1536              (1200u)
#define ESL_SIZEOF_WS_RSA_PRIV_1536             (1200u)
#define ESL_SIZEOF_WS_RSA_PRIV_CRT_1536         ( 820u)   /* assumes: p_bits, q_bits <= 800  */
/* n_bits <= 2048 */
#define ESL_SIZEOF_WS_RSA_PUB_2048              (1584u)
#define ESL_SIZEOF_WS_RSA_PRIV_2048             (1576u)
#define ESL_SIZEOF_WS_RSA_PRIV_CRT_2048         (1044u)   /* assumes: p_bits, q_bits <= 1056 */
/* n_bits <= 3072 */
#define ESL_SIZEOF_WS_RSA_PUB_3072              (2344u)
#define ESL_SIZEOF_WS_RSA_PRIV_3072             (2344u)
#define ESL_SIZEOF_WS_RSA_PRIV_CRT_3072         (1492u)   /* assumes: p_bits, q_bits <= 1568 */
/* n_bits <= 4096 */
#define ESL_SIZEOF_WS_RSA_PUB_4096              (3112u)
#define ESL_SIZEOF_WS_RSA_PRIV_4096             (3112u)
#define ESL_SIZEOF_WS_RSA_PRIV_CRT_4096         (1940u)   /* assumes: p_bits, q_bits <= 2080 */

/* RSA V15 core enc/dec workspace organisation
   WS_Header || Buffer || WS_RSA_PRIM (inkl. WS_RSA_PRIM_Header) */
#define ESL_WS_RSA_V15_ED_OFFSET_BUFFER                        (ACT_ALIGN (sizeof(eslt_WorkSpaceHeader)))
...
/* RSA V15 core sig/ver workspace organisation (SHA1)
   WS_Header || Buffer || WS_SHA1 (inkl. WS_SHA1_HEADER) || WS_RSA_PRIM (inkl. WS_RSA_PRIM_Header) */
...
/* RSA V15 core sig/ver workspace organisation (RIPEMD160)
   WS_Header || Buffer || WS_RIPEMD160 (inkl. WS_RIPEMD160_HEADER) || WS_RSA_PRIM (inkl. WS_RSA_PRIM_Header) */
#define ESL_WS_RSA_V15_SV_RIPEMD160_BUFFER                            (ACT_ALIGN (sizeof(eslt_WorkSpaceHeader)))
...
#define ESL_SIZEOF_WS_RSA_V15_SV_RIPEMD160_OVERHEAD_512               (ESL_SIZEOF_WS_RSA_V15_SV_RIPEMD160_OVERHEAD_1024 - 32u)
...
/* RSA V15 core sig/ver workspace organisation (SHA256)
   WS_Header || Buffer || WS_SHA256 (inkl. WS_SHA256_HEADER) || WS_RSA_PRIM (inkl. WS_RSA_PRIM_Header) */
#define ESL_WS_RSA_V15_SV_SHA256_BUFFER                            (ACT_ALIGN (sizeof(eslt_WorkSpaceHeader)))
...
/* RSA OAEP core enc/dec workspace organisation (SHA1)
   WS_Header || 2 x Buffer (RSA result, DB and temporary hash value) || WS_SHA1 (inkl. WS_SHA1_HEADER) || WS_RSA_PRIM (inkl. WS_RSA_PRIM_Header) */
#define ESL_WS_RSA_OAEP_ED_SHA1_BUFFER                            (ACT_ALIGN (sizeof(eslt_WorkSpaceHeader)))
...
/* RSA OAEP core enc/dec workspace organisation (SHA256)
   WS_Header || 2 x Buffer (RSA result, DB and temporary hash value) || WS_SHA256 (inkl. WS_SHA256_HEADER) || WS_RSA_PRIM (inkl. WS_RSA_PRIM_Header) */
#define ESL_WS_RSA_OAEP_ED_SHA256_BUFFER                            (ACT_ALIGN (sizeof(eslt_WorkSpaceHeader)))
...
/* RSA PSS core sig/ver workspace organisation (SHA1)
   WS_Header || 2 x Buffer (RSA result, DB and temporary hash value) || WS_SHA1 (inkl. WS_SHA1_HEADER) || WS_RSA_PRIM (inkl. WS_RSA_PRIM_Header) */
#define ESL_WS_RSA_PSS_SV_SHA1_BUFFER                            (ACT_ALIGN (sizeof(eslt_WorkSpaceHeader)))
...
/* RSA PSS core sig/ver workspace organisation (RIPEMD160)
   WS_Header || 2 x Buffer (RSA result, DB and temporary hash value) || WS_RIPEMD160 (inkl. WS_RIPEMD160_HEADER) || WS_RSA_PRIM (inkl. WS_RSA_PRIM_Header) */
#define ESL_WS_RSA_PSS_SV_RIPEMD160_BUFFER                           (ACT_ALIGN (sizeof(eslt_WorkSpaceHeader)))
...
/* RSA PSS core sig/ver workspace organisation (SHA256)
   WS_Header || 2 x Buffer (RSA result, DB and temporary hash value) || WS_SHA256 (inkl. WS_SHA256_HEADER) || WS_RSA_PRIM (inkl. WS_RSA_PRIM_Header) */
#define ESL_WS_RSA_PSS_SV_SHA256_BUFFER                            (ACT_ALIGN (sizeof(eslt_WorkSpaceHeader)))
...
/* =============================================================================
   ...
   ============================================================================= */
#define ESL_SIZEOF_WS_Ed25519                   (ESL_MINSIZEOF_WS_SHA512 + 2* ESL_SIZEOF_SHA512_DIGEST + ESL_SIZEOF_Ed25519_PUBLIC_KEY + 32u + 540u)
#define ESL_SIZEOF_WS_X25519                    (ESL_SIZEOF_X25519_PRIVATE_KEY + ESL_SIZEOF_X25519_PUBLIC_KEY + 540u)

/* =============================================================================
   = ChaCha20 & Poly1305 workspace sizes
   = (take alignment to 64bit into account)
   ============================================================================= */
#define ESL_SIZEOF_WS_ChaCha20                  (140)       /*  2* sizeof (block) + sizeof (int) */
#define ESL_SIZEOF_WS_Poly1305                  (180)       /*  sizeof (block) + sizeof (actU32) + sizeof (opaque) */
#define ESL_SIZEOF_WS_AEAD_ChaCha_Poly          (390)       /*  ESL_SIZEOF_WS_ChaCha20 + ESL_SIZEOF_WS_Poly1305 + 9* sizeof (actU32) */
...
typedef struct {
              eslt_WorkSpaceHeader header;
              eslt_Byte wsKDFX963SHA256 [ESL_MAXSIZEOF_WS_KDFX963SHA256];
...
typedef struct {
              eslt_WorkSpaceHeader header;
              eslt_Byte wsEcP [ESL_MAXSIZEOF_WS_ECP_SMALL];
      }eslt_WorkSpaceEcP_small;

typedef struct {
        eslt_WorkSpaceHeader header;
        eslt_Byte wsEcP [ESL_MAXSIZEOF_WS_ECP_LARGE];
    }eslt_WorkSpaceEcP_large;
...
typedef struct {
            eslt_WorkSpaceHeader header;
            eslt_Byte wsECBD [ESL_MAXSIZEOF_WS_ECBD];
    } eslt_WorkSpaceECBD;
