...
/* vadnra */
/* Bootloader doesn't use interrupts */
/* Can use call FblInterruptDisable() */
#define SuspendAllInterrupts() if(1);
#define ResumeAllInterrupts() if(1);
