---
title: "CAN Wakeup Port Note"
sidebar:
  order: 2
---

# CAN Wakeup Port Note

![Converted](https://img.shields.io/badge/converted--from-TXT-yellow)

> **Source:** `Demo/DemoFbl/Appl/README_CanWakeup.txt` (converted verbatim).
